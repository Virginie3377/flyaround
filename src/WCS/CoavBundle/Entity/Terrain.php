...
class Terrain
{
    ...
    /** * Add departures * * @param \WCS\CoavBundle\Entity\Flight $departures * @return Terrain */
    public function addDeparture(\WCS\CoavBundle\Entity\Flight $departures)
    { $this->departures[] = $departures;
        return $this;
    }

    /** * Remove departures * * @param \WCS\CoavBundle\Entity\Flight $departures */
    public function removeDeparture(\WCS\CoavBundle\Entity\Flight $departures)
    {
        $this->departures->removeElement($departures);
    }

    /** * Get departures * * @return \Doctrine\Common\Collections\Collection */
